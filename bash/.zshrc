...
# under VCS as dirty. This makes repository status check for large tories
# much, much faster.
...
# openvpn - saft
vpn_file="/home/felipe/saft/Assert-vpn-configlinux.ovpn"
alias vpn-login="openvpn3 session-start --config ${vpn_file}"
alias vpn-dis="openvpn3 session-manage --config ${vpn_file} --disconnect"
